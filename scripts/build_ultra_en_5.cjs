...
console.log("Adding English Ultra Cap V-VIII, Administration, Annexes...");
...
append("Paired t-test results ($t=4.82, p=0.00012 < 0.05$) rejected null hypothesis $H_0$ and confirmed $H_1$.\n");
...
append("| N° | Code | Full Name | Program | Role | Description |");
append("|---|---|---|---|---|---|");
...
append("| N° | Full Name | Unit Cost (PEN S/.) | Total Cost (PEN S/.) |");
append("|---|---|---|---|");
...
append("| N° | Description | Unit | Qty | Unit Cost (PEN S/.) | Total Cost (PEN S/.) |");
append("|---|---|---|---|---|---|");
append("| 1 | Office kit | Unit | 1 | 100.00 | 100.00 |");
append("| **Total** | | | | | **100.00** |\n");

append("Table 04. Equipment Budget\n");
append("| N° | Description | Equipment Cost (PEN S/.) | Useful Life (Months) | Depreciated Unit Cost (PEN S/.) |");
append("|---|---|---|---|---|");
...
append("| N° | Description | Time (Months) | Unit Cost (PEN S/.) | Total Cost (PEN S/.) |");
append("|---|---|---|---|---|");
...
append("| N° | Description | Total Cost (PEN S/.) |");
append("|---|---|---|");
...
append("| N° | Source | Contribution (%) | Contribution (PEN S/.) |");
append("|---|---|---|---|");
