...
console.log("Añadiendo Cap V-VIII, Administración y Anexos ultra extensos a TESIS_FINAL_SPORTMATCH_ES.md...");
...
append("Se formuló la hipótesis nula ($H_0$) y alternativa ($H_1$) para evaluar si el uso de SportMatch Connect incrementa la frecuencia semanal de actividad física en deportistas amateurs:\n");
append("- **$H_0$:** El uso de SportMatch Connect no genera un incremento estadísticamente significativo en la frecuencia semanal de actividad física de los usuarios ($\\mu_{\\text{post}} \\le \\mu_{\\text{pre}}$).\n");
append("- **$H_1$:** El uso de SportMatch Connect genera un incremento estadísticamente significativo en la frecuencia semanal de actividad física de los usuarios ($\\mu_{\\text{post}} > \\mu_{\\text{pre}}$).\n");
...
append("| N° | Código | Apellidos y Nombres | Carrera | Rol | Descripción |");
append("|---|---|---|---|---|---|");
...
append("| N° | Apellidos y Nombres | Costo Unitario (S/.) | Costo Total (S/.) |");
append("|---|---|---|---|");
...
append("| N° | Descripción | Unid. | Cant. | Costo Unit. (S/.) | Costo Total (S/.) |");
append("|---|---|---|---|---|---|");
append("| 1 | Kit de oficina | Unid. | 1 | 100.00 | 100.00 |");
append("| **Total** | | | | | **100.00** |\n");

append("Tabla 04. Presupuesto de Equipos\n");
append("| N° | Descripción | Costo del Equipo (S/.) | Tiempo Vida útil (Mes) | Costo Unitario Depreciado (S/.) |");
append("|---|---|---|---|---|");
...
append("| N° | Descripción | Tiempo (Meses) | Costo Unitario (S/.) | Costo Total (S/.) |");
append("|---|---|---|---|---|");
...
append("| N° | Descripción | Costo Total (S/.) |");
append("|---|---|---|");
...
append("| N° | Fuente | Aporte (%) | Aporte (S/.) |");
append("|---|---|---|---|");
...
console.log("Parte 5 ultra completada.");
