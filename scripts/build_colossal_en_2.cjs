...
console.log("Adding English Colossal Sections e, f, g (i-viii)...");
...
append("The project adopts a hybrid framework combining **Design Thinking** for problem discovery, **Lean Startup** for MVP validation, and the **Scrum** framework (complemented by Kanban) for software engineering.\n");
