...
console.log("Añadiendo Secciones g(ix-xi), h, i, 6, 7, 8 colosales a TESIS_FINAL_SPORTMATCH_ES.md...");

// g.ix MONITOREO Y CONTROL
append("## ix. Monitoreo y Control\n");
append("Se aplicó el marco de trabajo ágil **Scrum** (el cual es un marco de trabajo adaptativo y no una metodología) complementado con la técnica Kanban a lo largo de 4 meses (16 semanas) gestionado a través de Jira Cloud (`edwinfloress.atlassian.net/jira`).\n");
append("Figura 12");
...
console.log("Parte 3 colosal completada.");
