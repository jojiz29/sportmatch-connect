...
console.log("Adding English Mega Sections e, f, Cap II...");
...
append("\\[ S_{\\text{compatibility}} = w_1 S_{\\text{geography}} + w_2 S_{\\text{sport}} + w_3 S_{\\text{skill}} + w_4 S_{\\text{availability}} + w_5 S_{\\text{trust}} \\]\n");
