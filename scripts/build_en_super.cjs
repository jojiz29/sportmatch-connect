...
console.log("Generating Super Extended Final Thesis in English based on Downloads files...");
...
append("| Full Name | Student Code | % Participation | Project Role | Institutional Email | DNI |");
append("|---|---|---|---|---|---|");
append("| Edwin Junia Flores | U202X0001 | 100% | Scrum Master / Lead Software Architect | edwin.junia@usil.pe | 70123456 |");
append("| Erick Flores | U202X0002 | 100% | Backend / Security & Persistence Developer | erick.flores@usil.pe | 70234567 |");
append("| Juan Alonso Salvatierralonso | U202X0003 | 100% | Frontend / AI & UX Developer | juan.salvatierra@usil.pe | 70345678 |");
append("| Matías Rodrigo | U202X0004 | 100% | Computer Vision / QA & SRE Developer | matias.rodrigo@usil.pe | 70456789 |\n");
append("&nbsp;\n");
...
append("|---|---|");
append("| ____________________________ | **Edwin Junia Flores** <br> Code: U202X0001 <br> DNI: 70123456 |");
append("| ____________________________ | **Erick Flores** <br> Code: U202X0002 <br> DNI: 70234567 |");
append("| ____________________________ | **Juan Alonso Salvatierralonso** <br> Code: U202X0003 <br> DNI: 70345678 |");
append("| ____________________________ | **Matías Rodrigo** <br> Code: U202X0004 <br> DNI: 70456789 |\n");
append("---\n");
...
console.log("English super preliminaries completed.");
