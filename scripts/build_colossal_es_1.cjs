...
console.log("Generando Tesis Colosal en Español (USIL PFC III) - Parte 1...");
...
append("---\n");
append("&nbsp;\n");
append("# TRABAJO FINAL - TESIS DE INGENIERÍA DE SISTEMAS");
...
append("**Curso:** PROYECTO FINAL DE CARRERA III\n");
append("**Semestre:** 2026-I\n");
append("**Bloque:** FC-PREISF10B01N\n");
append("**Docente:** NEIRA NEIRA, KENNY DISNEY (kenny.neira@usil.pe)\n");
append("&nbsp;\n");
append("**Integrantes del Equipo:**\n");
append("| N° | Código | Alumno (Apellidos y Nombres) | Carrera | Estado | Email | % Part. | Rol en el Proyecto |");
append("|---|---|---|---|---|---|---|---|");
append("| 1 | 2111716 | FLORES SANCHEZ, EDWIN JUNIOR | ING SIST. INFORMACION | Activo | edwin.floress@usil.pe | 100% | Scrum Master / Arquitecto de Software Principal |");
append("| 2 | 2010830 | ANDRADE NOA, ALEJANDRO PAOLO | ING SIST. INFORMACION | Activo | alejandro.andrade@usil.pe | 100% | Desarrollador Fullstack / Especialista UI/UX |");
append("| 3 | 2010029 | ESPINOZA MAYTA, ERICK JAIR | ING. SOFTWARE | Activo | erick.espinozam@usil.pe | 100% | Desarrollador Backend / Seguridad & Persistencia |");
append("| 4 | 2121043 | GASTELU PONTE, MATIAS FERNANDO | ING SIST. INFORMACION | Activo | matias.gastelu@usil.pe | 100% | Desarrollador QA & DevOps / SRE |");
append("| 5 | 2121274 | SALVATIERRA RAMIREZ, JUAN ALONSO | ING SIST. INFORMACION | Activo | juan.salvatierra@usil.pe | 100% | Desarrollador Frontend / Especialista IA |\n");
append("&nbsp;\n");
append("**Línea de Investigación USIL (R. N° 074-2023/G):** Línea 2 — Tecnología de la información\n");
append("**Lima, Perú — 2026-I**\n");
append("---\n");
...
append("**Keywords:** Sports matchmaking, Feature-Sliced Design, NestJS 11, React 19, Supabase, PostGIS, Vertex AI, Stripe, Playwright, Scrum framework.\n");
append("---\n");
...
append("El informe se encuentra estructurado en estricto cumplimiento con la **Guía de Trabajo Final 2026** de la Facultad de Ingeniería e Inteligencia Artificial de la Universidad San Ignacio de Loyola (USIL) para el curso **PROYECTO FINAL DE CARRERA III** (Bloque: FC-PREISF10B01N), bajo la conducción del docente Ing. Kenny Disney Neira Neira...\n");
append("---\n");

console.log("Parte 1 colosal completada.");
