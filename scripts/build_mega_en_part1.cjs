...
console.log("Generating Mega Colossal English Thesis (USIL PFC III) - Part 1...");
...
append("&nbsp;\n");
append("**Course:** PROYECTO FINAL DE CARRERA III\n");
append("**Term:** 2026-I\n");
append("**Section:** FC-PREISF10B01N\n");
append("**Instructor:** NEIRA NEIRA, KENNY DISNEY (kenny.neira@usil.pe)\n");
append("&nbsp;\n");
append("**Team Members:**\n");
append("| N° | Code | Student (Last Name, First Name) | Program | Status | Email | % Part. | Project Role |");
append("|---|---|---|---|---|---|---|---|");
append("| 1 | 2111716 | FLORES SANCHEZ, EDWIN JUNIOR | ING SIST. INFORMACION | Active | edwin.floress@usil.pe | 100% | Scrum Master / Lead Software Architect |");
append("| 2 | 2010830 | ANDRADE NOA, ALEJANDRO PAOLO | ING SIST. INFORMACION | Active | alejandro.andrade@usil.pe | 100% | Fullstack Developer / UI Specialist |");
append("| 3 | 2010029 | ESPINOZA MAYTA, ERICK JAIR | ING. SOFTWARE | Active | erick.espinozam@usil.pe | 100% | Backend / Security & Persistence Developer |");
append("| 4 | 2121043 | GASTELU PONTE, MATIAS FERNANDO | ING SIST. INFORMACION | Active | matias.gastelu@usil.pe | 100% | QA & DevOps Engineer / SRE |");
append("| 5 | 2121274 | SALVATIERRA RAMIREZ, JUAN ALONSO | ING SIST. INFORMACION | Active | juan.salvatierra@usil.pe | 100% | Frontend Developer / AI Specialist |\n");
append("&nbsp;\n");
append("**USIL Research Line (R. N° 074-2023/G):** Line 2 — Information Technology\n");
append("**Lima, Peru — 2026-I**\n");
append("---\n");
...
append("1. The final project report titled **\"SPORTMATCH CONNECT: AN INTEGRAL PLATFORM FOR SPORTS MATCHMAKING, SOCIAL NETWORKING, TOURNAMENT MANAGEMENT, AND B2B/B2C MONETIZATION WITH EDGE ARTIFICIAL INTELLIGENCE\"** is an original work developed under advisor supervision by Prof. Kenny Disney Neira Neira.");
...
append("|---|---|");
append("| ____________________________ | **FLORES SANCHEZ, EDWIN JUNIOR** <br> Code: 2111716 <br> Email: edwin.floress@usil.pe |");
append("| ____________________________ | **ANDRADE NOA, ALEJANDRO PAOLO** <br> Code: 2010830 <br> Email: alejandro.andrade@usil.pe |");
append("| ____________________________ | **ESPINOZA MAYTA, ERICK JAIR** <br> Code: 2010029 <br> Email: erick.espinozam@usil.pe |");
append("| ____________________________ | **GASTELU PONTE, MATIAS FERNANDO** <br> Code: 2121043 <br> Email: matias.gastelu@usil.pe |");
append("| ____________________________ | **SALVATIERRA RAMIREZ, JUAN ALONSO** <br> Code: 2121274 <br> Email: juan.salvatierra@usil.pe |\n");
append("---\n");
...
console.log("English Part 1 completed.");
