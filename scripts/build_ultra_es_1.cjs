...
console.log("Generando Tesis Ultra Colosal en Español (USIL PFC III) - Parte 1...");
...
append("&nbsp;\n");
append("**Integrantes del Equipo (Equipo ##):**\n");
append("| N° | Código | Alumno (Apellidos y Nombres) | Carrera | Estado | Email Institucional | % Part. | Rol en el Proyecto |");
append("|---|---|---|---|---|---|---|---|");
...
console.log("Parte 1 ultra completada.");
