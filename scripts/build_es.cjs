...
console.log("Generando Tesis Final en Español con estructura exacta USIL 2026...");
...
append("| Nombre Completo | Código de Alumno | % Participación | Rol en el Proyecto |");
append("|---|---|---|---|");
append("| Edwin Junia Flores | U202X0001 | 100% | Scrum Master / Arquitecto de Software Principal |");
append("| Erick Flores | U202X0002 | 100% | Desarrollador Backend / Seguridad & Persistencia |");
append("| Juan Alonso Salvatierralonso | U202X0003 | 100% | Desarrollador Frontend / IA & UX |");
append("| Matías Rodrigo | U202X0004 | 100% | Desarrollador Computer Vision / QA & SRE |\n");
append("&nbsp;\n");
...
append("El informe se encuentra estructurado en estricto cumplimiento con la **Guía de Trabajo Final 2026** de la Facultad de Ingeniería e Inteligencia Artificial de la Universidad San Ignacio de Loyola (USIL) para el curso Proyecto Final de Carrera III...\n");
append("---\n");

console.log("Preliminares de build_es.cjs actualizados.");
