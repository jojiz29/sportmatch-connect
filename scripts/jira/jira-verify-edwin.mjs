...
const url =
  ...
  encodeURIComponent("key in (SCRUM-338, SCRUM-339, SCRUM-340, SCRUM-341, SCRUM-342, SCRUM-343, SCRUM-344, SCRUM-345)") +
...
if (!d.issues) {
  ...
  d.issues.forEach((i) => {
    ...
    console.log(
      "[" + i.key + "] Sprint: " + sprints + " | Status: " + i.fields.status.name + " | Assignee: " + (i.fields.assignee?.displayName || "none") + " | " + i.fields.summary
    );
  });
}
