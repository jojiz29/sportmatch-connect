...
test.describe("Community & Squads Integration Test", () => {
  ...
  test("should allow Fabiola to see Edwin's posts and join Edwin's squads", async ({
    page,
  }) => {
    ...
    await expect(page.locator('#feed-posts-list')).toContainText("¡Hola a todos! Este es mi primer post del día.");
