...
*   **Validación de usuarios reales:** Proveer un ecosistema confiable de emparejamiento deportivo (*matchmaking*) y reservas de canchas, protegiendo a la comunidad frente a actores maliciosos.
...
*   **Opt-in biométrico:** El proceso de verificación es opcional para el uso general de la plataforma, actuando como un mecanismo voluntario de mejora de la reputación digital (*trust score*).
