...
async function createDocument() {
  const doc = new Document({
    ...
    description:
      "Informe detallado de arquitectura de software, metodologías ágiles y entregables técnicos del Sprint 1 y Sprint 2 para SportMatch Connect",
    sections: [
      {
        properties: {},
        children: [
          ...
          createHeading(
            "1.1 Análisis de Deficiencias y Modelo de Negocio (Gap Analysis)",
          ...
          createTable([
            [
              ...
              "Arquitectura Propuesta V2 / Sprint 2",
            ],
            [
          ...
          // ================= SECCION 2 =================
          createHeading(
            "2. METODOLOGÍA ÁGIL Y PLANIFICACIÓN (SPRINTS 1 AL 4)",
          ...
          createTable([
            ...
            [
              "SCRUM-178",
              "Completar perfil deportivo en flujo guiado de 2 pasos",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-179",
              "Detectar foto de perfil automáticamente de Google OAuth",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-185",
              "Ver score de compatibilidad numérico con otros deportistas",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-186",
              "Reservar cancha interactiva seleccionando fecha y hora",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-190",
              "Visualizar balance de FitCoins en el dashboard principal",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-194",
              "Recibir notificaciones en tiempo real al ingresar nuevo partido",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-197",
              "Enviar y recibir mensajes en tiempo real en chats de squads",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
            [
              "SCRUM-201",
              "Crear partidos especificando deporte, cancha y nivel requerido",
              "Edwin Flores Sanchez",
              "Finalizada",
            ],
          ]),
          ...
          // ================= SECCION 3 =================
          createHeading(
            "3. SPRINT 1 - ENTREGABLES TÉCNICOS Y ARQUITECTURA",
            HeadingLevel.HEADING_1,
          ),
          createParagraph(
          ...
          createHeading(
            "3.1 Autenticación de Doble Vía e Integración de Google OAuth",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          createHeading(
            "3.2 Onboarding de 36 Deportes y Adaptabilidad Dinámica de Perfiles",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          // ================= SECCION 4 =================
          createHeading(
            "4. SPRINT 2 - INTEGRACIONES, BASE DE DATOS Y REALTIME",
            HeadingLevel.HEADING_1,
          ),
          createParagraph(
          ...
          createHeading(
            "4.1 Geolocalización Avanzada con PostGIS y Haversine en el Cliente",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          createHeading(
            "4.2 Wallet Deportiva de FitCoins y Procesador de Pagos Seguro",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          createHeading(
            "4.3 Canal Realtime para Notificaciones y Resolución de Concurrencia",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          createHeading(
            "5.1 Diagrama de Arquitectura Física y Lógica (Antes vs. Después)",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          createHeading(
            "5.2 Diagrama de Secuencia del Onboarding y Autenticación",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
          ...
          createHeading(
            "5.3 Diagrama de Flujo del Proceso de Reserva con Efecto Cascada",
            HeadingLevel.HEADING_2,
          ),
          createParagraph(
