...
export function WorldCupBackground() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-transparent transition-colors duration-300">
      {/* === BLOQUE: CAPAS DE BRILLO AMBIENTAL === */}
      {/* Brillo verde/oro flotante en la esquina superior izquierda (color primario) */}
      <div className="absolute top-1/4 -left-32 w-[500px] h-[500px] rounded-full bg-primary/3 dark:bg-primary/5 blur-[120px] animate-float" />
      {/* Brillo secundario flotante inverso en la esquina inferior derecha */}
      <div className="absolute bottom-1/4 -right-32 w-[400px] h-[400px] rounded-full bg-secondary/4 dark:bg-secondary/6 blur-[100px] animate-float-reverse" />
      ...
      >
        ...
        />
        {/* Trazo curvo del color primario decorativo */}
        <path
          ...
          strokeLinecap="round"
        />
        {/* Trazo curvo secundario decorativo complementario */}
        <path
      ...
      {/* Patrón de puntos sutiles con el color primario de la temporada activa para texturizar el fondo */}
      <div
      ...
      {/* Bordes decorativos con el color primario en las esquinas superior izquierda e inferior derecha */}
      <div className="absolute top-0 left-0 w-40 h-40 border-t-2 border-l-2 border-primary/5 rounded-tl-3xl" />
      <div className="absolute bottom-0 right-0 w-40 h-40 border-b-2 border-r-2 border-primary/5 rounded-br-3xl" />
    </div>
  );
}
